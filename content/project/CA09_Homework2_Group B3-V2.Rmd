...
When using this function, we added two options: `skip` and `na`.
...
knitr::include_graphics(here::here("images_project", "tfl_distributions_monthly.png"))
```
...
knitr::include_graphics(here::here("images_project", "tfl_monthly.png"))
```
...
knitr::include_graphics(here::here("images_project", "tfl_weekly.png"))
```
